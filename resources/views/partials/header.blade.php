        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::current()->getName() == 'admin.projects.deleted' ? 'active' : '' }}"
                            aria-current="page" href="{{ route('admin.projects.deleted') }}">
                            Show deleted
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::current()->getName() == 'admin.projects.create' ? 'active' : '' }}"
